...
//	@Mar. 15th
//		.Add check against return value of CSitubeRender::run() not equal to 0
//		in _armRenders() so that failure in any of the sub-renders' startup will
//		terminate the multiple render process, as is much safer
//
