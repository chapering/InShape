...
public:
	 ...
	 * @param fnear distance from viewpoint to the near clip plane
	 * @param ffar distance from viewpoint to the far clip plane
	 * @return none
	 */
	void setPrjInfo(GLdouble fvoy, GLdouble fnear, GLdouble ffar);
