...
// @Aug. 24th 2011
//			.Add configurable STEREOSCOPIC display support
//			
...
protected:
	 ...
	 * @note this simply provides an alternative to overload the display
	 *  procedure against display(), which would be more preferrable for those
	 *  lazybones whose do not even bother to write the routine calls in the
	 *  display() callback like glClear(...) at the beginning and trigger() at
	 *  the end
	 * @return none
	 */
	virtual void draw();
