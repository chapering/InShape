...
//	@Jul. 15th
//		1.Add COptionPanel for a simple GUI panel to hold buttons, migrated from
//		density study, box-button-panel option style version.
//	@Aug. 27th
//		.Add support of stereoscopic display
//
