...
//			  June.29th 2011 add transposemat for transposing a 4x4 matrix
...
// display text in 2D screen with incoming 2D window coordinates 
inline void printTextIn2D(const char* pstr,
		GLint x, GLint y,
		...
		void* font = GLUT_BITMAP_TIMES_ROMAN_24)
{
	...
	for ( i = 0; i < len; i++) {
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, pstr[i]);
	}
...
// display text in 2D screen with incoming coordinates in 3D object coordinate system
