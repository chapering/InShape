...
// @Aug. 24th 2011
//		.Add Stereoscopic display support
// @May. 16th 2012
//		.Add SuperEllipse shaped fiber tube encoding
//		.And, provide options for encoding FA to the N-parameter of super-ellipse
//		.add switching options between wireframe and surface representation
//
...
public:
	...
	/* build tube geometries (meshes) from streamline points */
	void buildTubefromLine(unsigned long lineIdx);

	/*
	 * Building artificial tubes by creating a super-ellipse at each streamline 
	 * points and then connecting key points at adjacent super-ellipses.
	 */
	void __buildSuperEllipseTube(unsigned long lineIdx);
	 ...
	 */
	void __buildStreamtube(unsigned long lineIdx);
...
protected:
	...
	*/
	...
	// use streamtube or super ellipse
	bool	m_bSuperEllipseEncoding;

	// use wireframe or surface to represent tubes
	bool	m_bWireframe;
protected:
